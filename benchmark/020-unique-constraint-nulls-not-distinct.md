...
## Refresh note (2026-06-05)

pg-delta advanced from `ee9385daf75f72d443882020247ffd2599050090` to
`b9b8b157c23e08e9d8a9c7573718edcc06f603c3` during this refresh. The new upstream
change adds `NOT VALID` constraint convergence handling, but it does not change
this benchmark's parity state.
