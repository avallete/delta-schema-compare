...
- **#436** required extensions in dump output — **covered** in pg-delta's
  extension export and integration coverage
...
- **#416** custom aggregates omitted from dump — **screened, no duplicate
  issue drafted**; current pg-delta models aggregates as first-class catalog
  objects and already covers aggregate create/drop paths, so this looks
  pgschema-dump-specific rather than a current pg-delta gap
...
- **#49 / #406 / #407 / #409 / #419 / #429** rename workflow /
