...
>   [#537](https://github.com/pgplex/pgschema/issues/537), and
>   [#538](https://github.com/pgplex/pgschema/issues/538) remain **covered** in
>   current pg-delta; newly closed
>   [#545](https://github.com/pgplex/pgschema/issues/545) is also already
>   handled by pg-delta's existing `pg_depend`-driven routine/type ordering
