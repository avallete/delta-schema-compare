...
## Latest refresh snapshot (2026-05-13)
...
- **#406 / #407 / #409 / #429** `.pgschemaignore` and constraint-separation follow-ups — **not parity work for pg-delta** (pgschema-specific workflow/config surface area)

Current draft text is recorded in markdown here:

- [`docs/parity-issue-drafts-2026-05-13.md`](../docs/parity-issue-drafts-2026-05-13.md)
...
- **#412** table-level `UNIQUE NULLS NOT DISTINCT` constraints — **not covered**
  ...
  `docs/parity-issue-drafts-2026-05-13.md`
