# Parity refresh report - 2026-07-14

This report records the 2026-07-14 latest-state parity check between:
...
- live `pg-toolbelt` `main` (`d3b3c8b6b7f5e9a85c765284a2a5e9f69cbb97f5`), which is still the same CI-only commit ahead already seen on 2026-07-10 through 2026-07-13

## 1) Benchmark status refresh

This refresh found **no benchmark-matrix delta** versus
[`docs/parity-refresh-2026-07-13.md`](./parity-refresh-2026-07-13.md).
...
## 2) Upstream delta on 2026-07-14

This refresh found **no new upstream parity movement** after the 2026-07-13
sweep:

- `pgschema` `main` remains `e18d9ede7973537919c02f25eced5c97271af1dc`
- the current open pgschema issue set is unchanged and still consists of
...
- the latest closed parity-relevant pgschema issues are still
  ...
  [#509](https://github.com/pgplex/pgschema/issues/509); higher visible numbers
  **#510**, **#511**, and **#512** remain PRs rather than issues
...
- the latest pg-toolbelt tracker state is still non-duplicative and unresolved:
  - [#218](https://github.com/supabase/pg-toolbelt/issues/218) remains
    issue-only with no PR, although it now includes a Jun 18 contributor comment
    pointing to a ready branch and local test validation for the requested
    parity coverage
...
- add this report as the 2026-07-14 latest-state sweep
- annotate `benchmark/README.md` so the source-of-truth matrix points to this
  follow-up and records that the 2026-07-14 sweep again found no benchmark or
  upstream parity delta after 2026-07-13
