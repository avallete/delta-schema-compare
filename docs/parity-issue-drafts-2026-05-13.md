# Parity issue drafts — 2026-05-13

This refresh did **not** produce any new draft issues for open pgschema items.
...
The new draft below is for the one remaining **historical** gap that is still
missing from pg-toolbelt tracking.
