# Parity refresh report - 2026-06-07
...
There is no resolved-issue parity-state delta versus the 2026-06-05 refresh.
...
There is no open-issue parity-state delta versus the 2026-06-05 refresh.
...
- pgschema [#444](https://github.com/pgplex/pgschema/issues/444): `DROP COLUMN`
  ...
  - pg-delta still has related but not identical dependency-ordering work in
    ...
    open PR [#273](https://github.com/supabase/pg-toolbelt/pull/273)
...
- pgschema [#420](https://github.com/pgplex/pgschema/issues/420) remains
  **covered** in pg-delta even though upstream fix PR
  [#438](https://github.com/pgplex/pgschema/pull/438) is now merged
...
No newer parity-relevant open pgschema issues appeared since the 2026-06-05
refresh.

## 3) Recently closed issue screening

No new parity-relevant pgschema closed issues or merged fix PRs changed the
benchmark since the 2026-06-05 refresh. The screened closed-item state remains
unchanged:
