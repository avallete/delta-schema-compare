# Parity refresh report - 2026-06-19
...
- pgschema [#479](https://github.com/pgplex/pgschema/pull/479):
  ...
  - the current trigger replacement path serializes:
  ...
  - a new draft-only pg-delta issue body is saved in
