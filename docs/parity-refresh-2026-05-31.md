# Parity refresh report - 2026-05-31
...
- pgschema [#420](https://github.com/pgplex/pgschema/issues/420):
  ...
  - upstream pgschema fix PR [#438](https://github.com/pgplex/pgschema/pull/438)
    is now merged, but the issue itself remains open
...
- There is no parity-state delta versus the 2026-05-29 refresh.
...
- There is still no matching pg-toolbelt issue or PR for pgschema #412, #420,
  #427, or #439.
- The notable deltas from the previous refresh are that pgschema PR #438 is now
  merged for #420 while the issue remains open, issues #406 and #408 are now
  closed, and newly closed issues #445 and #446 screen as not parity work.
- No new pg-delta issue should be drafted from this sweep.
